...
C {sky130_fd_pr/corner.sym} -1155 -577.5 0 0 {name=CORNER2 only_toplevel=false corner=ss
}
...
C {devices/lab_pin.sym} 220 160 0 0 {name=p52 sig_type=std_logic lab=out}
...
C {devices/vcvs.sym} 380 207.5 0 0 {name=E2 value=-1
}
C {devices/lab_pin.sym} 340 187.5 0 0 {name=p34 sig_type=std_logic lab=fbp}
C {devices/lab_pin.sym} 340 227.5 0 0 {name=p35 sig_type=std_logic lab=fbn}
C {devices/lab_pin.sym} 380 237.5 3 0 {name=p36 sig_type=std_logic lab=0}
C {devices/lab_pin.sym} 380 160 0 0 {name=p37 sig_type=std_logic lab=CL}
