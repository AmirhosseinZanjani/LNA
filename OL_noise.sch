...
ac dec 10 0.1 1k
let gaind=(v(out_p)-v(out_n))/(v(VINP1)-v(VINN1))
let gainc=(v(f3))/(v(f4))
plot db(gaind)
plot db(gaind/gainc)
.endc
...
C {devices/vcvs.sym} -410 -555 0 0 {name=E1 value=0.5
}
C {devices/vcvs.sym} -250 -555 0 0 {name=E7 value=-0.5
}
C {devices/vsource.sym} -335 -475 0 0 {name=V4 value=0.9}
C {devices/lab_pin.sym} -495 -435 3 0 {name=p23 sig_type=std_logic lab=0}
C {devices/lab_pin.sym} -575 -575 0 0 {name=p24 sig_type=std_logic lab=VIN1}
C {devices/lab_pin.sym} -410 -680 2 1 {name=p26 sig_type=std_logic lab=VINP1}
C {devices/lab_pin.sym} -250 -690 0 1 {name=p28 sig_type=std_logic lab=VINN1}
